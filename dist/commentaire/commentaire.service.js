...
let CommentaireService = class CommentaireService {
    constructor(comentRepo, eventRepo, userRepo) {
        this.comentRepo = comentRepo;
        this.eventRepo = eventRepo;
        this.userRepo = userRepo;
    }
    async create(idEvent, idUser, createCommentaireDto) {
    ...
    async update(id, updateCommentaireDto) {
        ...
        if (!findCom)
            throw new common_1.NotFoundException('Cette Commentaire n existe pas');
